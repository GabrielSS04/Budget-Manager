  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <p>
          Take control of your finances with Personal Budget Manager <strong>Simple</strong>, <strong>Smart</strong>, and <strong>Efficient</strong>!
        </p>
      </div>
      ...
      <div className="cards">
        <div className="content1 card">
          ...
          <p>
            ...
            adding your earnings, such as salary or freelance work, and logging
            your expenses, like rent, bills, or shopping, you can monitor your
            financial situation in a straightforward way. You will have the
            ability to add, edit, or remove any entry as needed.
          </p>
        </div>
        <div className="content2 card">
          <img src={person} alt="" className="icon" />
          <p>
            On the <strong>Dashboard</strong>, you will find a complete overview
            of your financial life. It not only displays the total of your
            income and expenses but also provides detailed charts to help you
            visualize where your money is going and understand the overall
        ...
        <div className="content3 card">
          ...
          <p>
            ...
            can view your financial information. We hope this platform helps you
            gain better control over your finances and achieve your financial
            goals with ease.
          </p>
        </div>
      </div>
